package com.example.itoledo.proyecto5_pdm;
...
public class Formulario extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Si extra esta a null vuelve atras
        ...
        txt_Archivo = (TextView) findViewById(R.id.textViewUri);
        //Make Event Button
        btn_img.setOnClickListener(new Button.OnClickListener() {
                                       ...
                                       public void onClick(View v) {
                                           ...
                                           if(imgFile.exists())
                                           {
                                               ...
                                               ImageView myImage = (ImageView) findViewById(R.id.icon);
    ...
    //Establece el modo de trabajo del formulario
    ...
    private void activarCamara(){
        ...
        //set the file name
        txt_Archivo.setText(fileUri.getPath());
